...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="<?php echo site_url('dosen'); ?>" class="w3-bar-item w3-button w3-padding-large w3-black">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span> Dosen </h1>
  ...
  <div class="w3-row-padding" style="margin:0 -16px">
	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          <li class="w3-dark-grey w3-xlarge w3-padding-32">Input Data Dosen</li>
          <li class="w3-padding-16">
			...
			<center>
			<table>
				<tr><td>NIP</td><td width="300"><?php echo form_input('',$dosen[0]->nip,"disabled");?></td></tr>
				<tr><td>NAMA</td><td width="300"><?php echo form_input('nmds',$dosen[0]->nmds);?></td></tr>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
	...
	<center>	
	<table border="1">
    <tr><th>NIP</th><th>NAMA</th><th></th></tr>
    <?php
	
    foreach ($dosen as $d){
        echo "<tr>
              <td width='200'>$d->nip</td>
              <td  width='400'>$d->nmds</td>
              <td  width='175'>".anchor('dosen/edit/'.$d->nip,'Edit')."
                  ".anchor('dosen/delete/'.$d->nip,'Delete')."</td>
              </tr>";
    }
    ?>
	</table>
