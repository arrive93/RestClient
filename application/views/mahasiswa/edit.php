...
<div class="w3-padding-large" id="main">
	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">
			...
			<center>
			<table>
				<tr><td>NIM</td><td width="300"><?php echo form_input('',$mahasiswa[0]->nim,"disabled");?></td></tr>
				<tr><td>NAMA</td><td width="300"><?php echo form_input('nama',$mahasiswa[0]->nama);?></td></tr>
				<tr><td>PRODI</td><td>
						<select name="prodi">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    foreach ($mahasiswa as $m){
        echo "<tr>
              <td width='200'>$m->nim</td>
              <td  width='400'>$m->nama</td>
              <td  width='150'>$m->prodi</td>
