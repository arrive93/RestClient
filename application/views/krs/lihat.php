...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span> KRS Mahasiswa </h1>
  ...
  <div class="w3-row-padding" style="margin:0 -16px">
	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-dark-grey w3-xlarge w3-padding-32">Kirim KRS Mahasiswa</li>
          <li class="w3-padding-16">
		  
		  
		  <?php echo form_open('krs/lihat');?>
			 
			<center>
			<table>
				
				
				<tr><td>NIM : </td><td width="300"><?php echo form_input('nim');?>
					<?php echo form_submit('submit','Kirim KRS');?></td></tr>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
	...
	<center>	
	<table border="1">
    <tr><th>NIM</th><th>NAMA MAKUL</th><th>DOSEN</th></tr>
    <?php
	
    foreach ($krs as $k){
        echo "<tr>
              <td width='200'>$k->nim</td>
              <td  width='400'>$k->nmmk</td>
              <td  width='150'>$k->nmds</td>
              </tr>";
			  
    }
	
	echo anchor('krs','Tambah KRS');
    ?>
