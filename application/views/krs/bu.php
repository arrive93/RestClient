...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="<?php echo site_url('mahasiswa'); ?>" class="w3-bar-item w3-button w3-padding-large w3-black">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="hitungbobotvektor.php" class="w3-bar-item w3-button" style="width:25% !important">KRS</a>
  </div>
</div>
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span> Mahasiswa </h1>
  ...
  <div class="w3-row-padding" style="margin:0 -16px">
	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          <li class="w3-dark-grey w3-xlarge w3-padding-32">Input Data Mahasiswa</li>
          <li class="w3-padding-16">
			...
			<table>
				...
				<table border="1">
				<tr><th colspan="4">
				NIM : <?php echo form_input('nim',$mahasiswa[0]->nim,"disabled");?>
				</th></tr>
				<tr><th>KODE MAKUL</th><th>NAMA MAKUL</th><th>SKS</th><th></th></tr>
				<?php
				
				foreach( $matakuliah as $mk)
				{
					echo "<tr>
						  <td width='100'>".form_hidden('kdmk',$mk->kdmk)."$mk->kdmk</td>
						  <td  width='250'>".form_hidden('nmmk',$mk->nmmk)."$mk->nmmk</td>
						  <td  width='100'>".form_hidden('sks',$mk->sks)."$mk->sks</td>
						  <td  width='175'>
							  ".form_submit('submit','Tambahkan KRS')."</td>
						  </tr>";
				}
				?>
				
				<?php echo form_hidden('nmds','BT');?>
				</table>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
	...
	<center>	
	<table border="1">
    <tr><th>NIM</th><th>KODE MAKUL</th><th>NAMA MAKUL</th><th>SKS</th><th>DOSEN</th><th></th></tr>
    <?php
	
    foreach ($krs as $k){
        echo "<tr>
              <td width='200'>$k->nim</td>
              <td  width='400'>$k->kdmk</td>
              <td  width='150'>$k->nmmk</td>
              <td  width='400'>$k->sks</td>
              <td  width='150'>$k->nmds</td>
              <td  width='175'>".anchor('mahasiswa/edit/'.$m->nim,'Edit')."
