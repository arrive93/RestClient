	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">
			...
			<center>
			<table>
				<tr><td>KODE MAKUL</td><td width="300"><?php echo form_input('',$matakuliah[0]->kdmk,"disabled");?></td></tr>
				<tr><td>NAMA MAKUL</td><td width="300"><?php echo form_input('nmmk',$matakuliah[0]->nmmk);?></td></tr>
				<tr><td>SKS</td><td>
					<select name="sks">
