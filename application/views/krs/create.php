...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="<?php echo site_url('krs'); ?>" class="w3-bar-item w3-button w3-padding-large w3-black">
    <i class="fa fa-envelope w3-xxlarge"></i>
    <p>KRS</p>
  </a>
</nav>
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span> KRS </h1>
  ...
  <div class="w3-row-padding" style="margin:0 -16px">
	  ...
	  <div class="w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          <li class="w3-dark-grey w3-xlarge w3-padding-32">Input Mata Kuliah</li>
          <li class="w3-padding-16">
			...
			<center>
			<table>
				<tr><td width="300">NIM : <?php echo form_input('nim',$mahasiswa[0]->nim,"disabled");?></td></tr>
				<tr><td><hr></td><td width="300"><hr></td><td><hr></td></tr>
				...
				foreach ($matakuliah as $mk){
					echo "<tr>
						  <td>
						  <input type='radio' name='nmmk' value='$mk->nmmk'> ($mk->kdmk) - $mk->nmmk</td>
						  </tr>";
				}
				?>
				<tr><td colspan="2">
				<br>
					...
					<?php echo anchor('krs/lihat','Lihat KRS');?></td></tr>
			</table>
			<?php
			echo form_close();
			?>
